...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'carfi-element-ui/src/utils/date-util';
  import ElScrollbar from 'carfi-element-ui/packages/scrollbar';
  import RepeatClick from 'carfi-element-ui/src/directives/repeat-click';
