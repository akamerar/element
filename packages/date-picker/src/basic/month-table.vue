...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'carfi-element-ui/src/utils/date-util';
  import { hasClass } from 'carfi-element-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'carfi-element-ui/src/utils/util';
